...
This program stores and queries information about user song listening behavior, such as which users listen in a certain time period and an estimate of each user's favorite genre.

## Dataset Description

There are two datasets: listening_logs.csv and songs_metadata.csv.

listening_logs.csv records instances of a user listening to a song, including user_id, song_id, timestamp, and duration in seconds

songs_metadata.csv covers information about a song, such as: title, artist, genre, mood

## Repository Structure

Every file is in the same base directory.

## Output Directory Structure

The file generated by datagen.py are saved to the same folder as datagen.py, and the outputs of main.py are simply written to the log.
